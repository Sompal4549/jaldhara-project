        ...
        >
          {Array.from({ length: 5 }).map((_, ind) => (
            <div
              ...
              // }`}
              className={`min-w-full md:h-[720px] flex flex-row  rounded-s-lg md:px-0 px-0 ${
                ind === index ? "" : "opacity-0"
              }`}
            >
              <div className="flex flex-col md:flex-row bg-white rounded-lg">
                <div className="img-container w-full md:w-[55%] bg-blend-multiply rounded-lg">
                  <Image
                    ...
                    width={750}
                    height={720}
                    className="w-full md:w-auto h-[290px] md:h-full max-h-[720px] bg-primary rounded-s-lg object-cover object-top-left"
