...
const ProductsSection = () => {
  ...
  const Card = ({ imgUrl, title, text }) => {
    return (
      <div
        className={`p-4 relative card w-[160px] h-[160px] min-w-[160px] md:w-[320px] md:min-w-[320px] md:h-[320px] bg-[url('/Subtract.svg')] bg-cover bg-center bg-no-repeat after:content-['']  after:absolute after:bottom-0 after:right-0 after:bg-[url('/pipes.svg')] after:h-[60%] after:top:[40%] after:bg-cover after:bg-center after-z-10 after:w-[80%]`}
      >
        <div className="w-[50%]">
